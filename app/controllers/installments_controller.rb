class InstallmentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @installment.save
        format.html { redirect_to project_path(@installment.project_id), notice: 'Installment was successfully created.' }
  ...
  private
    ...
    def installment_params
      params.require(:installment).permit(:project_id, :amount, :installment_date, :status, :details)
    end
end
